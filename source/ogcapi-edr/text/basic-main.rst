...
.. csv-table:: Overview of OGC API - Features resources
   ...
   "Collections metadata", "{root}/collections", "Metadata describing the collections of data available from this API."
   "Single Collection metadata", "{root}/collections/{collectionId}", "Metadata describing the collection of data which has the unique identifier {collectionId}"
